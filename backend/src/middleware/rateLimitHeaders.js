 ...
 */
export function addRateLimitHeaders(_c, _next) {
  return async (c, next) => {
 ...
 */
export function dynamicRateLimitHeaders(operationType) {
  return async (c, next) => {
 ...
 */
function getRateLimitsForOperation(operationType) {
  const limits = {
    // Autenticação
 ...
 */
export function rateLimitUsageLogger(operationType) {
  return async (c, next) => {
