 ...
 */
export function applyGranularRateLimit(operationType) {
  return async (c, next) => {
 ...
 */
function getRateLimiterForOperation(operationType) {
  const limiters = {
    // Autenticação
 ...
 */
export function abuseDetectionMiddleware(operationType) {
  return async (c, next) => {
 ...
 */
export function rateLimitWithAbuseDetection(operationType) {
  return [
