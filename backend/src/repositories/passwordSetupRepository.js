export async function revokeOpenSetupTokensForUser(client, userId) {
  await client.query(
...
export async function createPasswordSetupToken(client, tokenData) {
...
export async function consumeSetupToken(client, tokenId) {
  await client.query(
...
export async function deleteExpiredSetupTokens(client) {
  await client.query(
